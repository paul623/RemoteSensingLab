...
f = open(filedialog.askopenfilename(title=u"Open the parameter settings file:", initialdir=r'F:\Xiaolin lab\python_fsdaf_updated_20210331\py_FSDAF_0331\ToSunyue'))
...
temp_file = filedialog.askdirectory(title=u"Set the temporary folder", initialdir=r'F:\Xiaolin lab\python_fsdaf_updated_20210331\py_FSDAF_0331\ToSunyue')

# open the fine image of the first pair
path1 = filedialog.askopenfilename(title=u"open the fine image of the first pair:", initialdir=r'F:\Xiaolin lab\python_fsdaf_updated_20210331\py_FSDAF_0331\ToSunyue')
...
path2 = filedialog.askopenfilename(title=u"open the coarse image of the first pair:", initialdir=r'F:\Xiaolin lab\python_fsdaf_updated_20210331\py_FSDAF_0331\ToSunyue')
...
path3 = filedialog.askopenfilename(title=u"open the coarse image of the prediction time:", initialdir=r'F:\Xiaolin lab\python_fsdaf_updated_20210331\py_FSDAF_0331\ToSunyue')
